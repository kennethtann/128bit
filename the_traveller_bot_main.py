import os, requests
#import telebot
#BOT_TOKEN = "6157766860:AAE_pElWsUCtP1BoxQPd8TiZ6e4NrS5zdzE"
#BOT_TOKEN = os.environ.get("BOT_TOKEN")

# bot = telebot.TeleBot(BOT_TOKEN)
#
# @bot.message_handler(commands=['start', 'cancelhls'])
# def send_welcome(message):
#     bot.reply_to(message, "Tmr hls cancelled.")
#
...
# Telegram bot token
TOKEN = "5874016579:AAFM9f93zyEsDLmWlweNepfybfpcQUm5vCs"
...
def main():
    ...
    # |Schedule journal reminder for existing users
    #existing_users = updater.bot.get_updates()[-1].message.chat_id
    #for chat_id in existing_users:
    #    schedule_journal_reminder(chat_id)
